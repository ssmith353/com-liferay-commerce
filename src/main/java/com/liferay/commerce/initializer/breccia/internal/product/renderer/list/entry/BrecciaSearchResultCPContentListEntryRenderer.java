...
package com.liferay.commerce.initializer.breccia.internal.product.renderer.list.entry;
...
@Component(
	immediate = true,
	property = {
		"commerce.product.content.list.entry.renderer.key=" + BrecciaSearchResultCPContentListEntryRenderer.KEY,
...
public class BrecciaSearchResultCPContentListEntryRenderer
