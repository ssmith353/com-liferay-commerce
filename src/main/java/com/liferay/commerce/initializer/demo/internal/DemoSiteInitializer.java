...
package com.liferay.commerce.initializer.demo.internal;
...
public class DemoSiteInitializer implements SiteInitializer {
	...
	public static final String KEY = "demo-initializer";
	...
	public String getDescription(Locale locale) {
		...
		return LanguageUtil.get(resourceBundle, "demo-description");
	}
	...
	public String getName(Locale locale) {
		...
		return LanguageUtil.get(resourceBundle, "boron");
	}

	@Override
	public String getThumbnailSrc() {
		return _servletContext.getContextPath() +
			"/images/Demo-Logo-Square.jpg";
	}
	...
	public boolean isActive(long companyId) {
		Theme theme = _themeLocalService.fetchTheme(companyId, _DEMO_THEME_ID);

		if (theme == null) {
			if (_log.isInfoEnabled()) {
				_log.info(_DEMO_THEME_ID + " is not registered");
			}
	...
	private String _getJSON(String name) throws IOException {
		return StringUtil.read(
			DemoSiteInitializer.class.getClassLoader(),
	...
	private void _importAssetCategories(ServiceContext serviceContext)
		...
		ClassLoader classLoader = DemoSiteInitializer.class.getClassLoader();
	...
	private void _importJournalArticles(ServiceContext serviceContext)
		...
		_cpFileImporter.createJournalArticles(
			jsonArray, DemoSiteInitializer.class.getClassLoader(),
	...
	private void _initialize(long groupId) throws Exception {
		...
		_cpFileImporter.updateLookAndFeel(
			_DEMO_THEME_ID, false, serviceContext);
	...
	private void _updateLogo(ServiceContext serviceContext) throws Exception {
		...
		InputStream inputStream = classLoader.getResourceAsStream(
			_DEPENDENCIES_PATH + "images/Demo-Logo.png");
	...
	private void _updateThemeSetting(
		...
		Theme theme = _themeLocalService.fetchTheme(
			serviceContext.getCompanyId(), _DEMO_THEME_ID);
	...
	private static final String _DEMO_THEME_ID = "demo_WAR_commercethemedemo";

	private static final String _DEPENDENCIES_PATH =
		"com/liferay/commerce/initializer/demo/internal/dependencies/";
	...
	@Reference(
		target = "(osgi.web.symbolicname=com.liferay.commerce.initializer.demo)"
	)
