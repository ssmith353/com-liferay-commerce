...
package com.liferay.commerce.initializer.demo.internal.product.renderer.list.entry;
...
@Component(
	immediate = true,
	property = {
		"commerce.product.content.list.entry.renderer.key=" + DemoSearchResultCPContentListEntryRenderer.KEY,
...
public class DemoSearchResultCPContentListEntryRenderer
	implements CPContentListEntryRenderer {

	public static final String KEY = "search-result-demo";
